...
export default async function handler(req, res) {
  ...
  // 3. POŠLI AI - PRO POPISY, PRODUKTY, NOVINKY A FAQ!
  let aiReply = "";
  let tokensUsed = null;
  try {
...
ÚKOL: Z obsahu webu rekant.cz vytvoř JSON s POPISY SLUŽEB, PRODUKTŮ, NOVINEK A FAQ.

DŮLEŽITÉ: 
- NEPIŠEŠ telefony, emaily, adresu, IČO ani jiné kontakty!
- Soustřeď se POUZE na popisy služeb, produktů, novinky a FAQ otázky
...
STRUKTURA:
{
  ...
  "news": [
    {
      "id": "news_1",
      "title": "Nová fada Konica Minolta...",
      "description": "Krátký popis novinky",
      "tag": "Novinka",
      "author": "Rekant",
      "date": "2026-03-15"
    }
...
Tagy pro novinky: "Novinka", "Akce", "Tip"
Vytvoř MINIMÁLNĚ 10 FAQ otázek. POUZE JSON!`,
  ...
  const mergedKB = {
    ...
    news: parsedKB.news || currentKB.news || [],
    ...
    lastScan: {
      ...
      preserved: ["company"],
      updated: ["services", "products", "news", "faq"],
  ...
  return res.status(200).json({
    success: true,
    message: "Web naskenován! Popisy, novinky a FAQ aktualizovány, kontakty zachovány.",
    kb: mergedKB,
    tokensUsed,
    preserved: ["company - kontakty se nepřepisují, edituj je v záložce Firma"],
    updated: ["services - popisy služeb", "products - popisy produktů", "news - novinky a akce", "faq - otázky a odpovědi"],
  });
}
